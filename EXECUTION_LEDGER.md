...
**F1–F4 are the critical path to the first student and first partnership.**
...
| N2 | Verify education-loan referral programmes (GyanDhan-type, NBFCs) and draft outreach | Revenue | pending |
