...
|---|---|---|---|
| **F-NEW-1** | **Confirm the Debrecen Feb 2027 deadline** — sources conflict (1 Nov 2026 vs a stale 15 Nov 2024 on their own page). You are an existing partner; one email settles it | **A missed deadline costs a whole intake.** Blocks every February campaign date | ~5 min |
