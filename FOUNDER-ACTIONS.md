...
**Only genuinely unavoidable founder actions.** Routine technical work has been executed
autonomously and does not appear here.

## Unavoidable — external authority or credential
...
| 7 | **Add real mentors with checkable credential URLs** | Requires knowing actual people. Fabricating them is the single most damaging invention available. | mentor matching |

## Executed autonomously — deliberately NOT founder work
...
Website, DNS, Cloudflare, GoDaddy, Slate — a separate employee owns the rebuild.
