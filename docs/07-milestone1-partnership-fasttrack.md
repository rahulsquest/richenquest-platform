# File 07 — MILESTONE 1: Partnership Fast-Track (v2 — FACT-CORRECTED)
Supersedes v1 entirely. Every claim below passes the Verified Claims Library (File 08).
Remaining fill-ins: [FOUNDER NAME], [PHONE], [CIN], [OFFICE ADDRESS].

---

## 1. THE IU EMAIL (send to: partners@iu.org, from official@richenquest.com only)

**Subject:** Agent partnership application — RichenQuest (India & Nepal)
...
We are deliberately early-stage and building carefully: we maintain verified records for every student we place, run two-person document verification before any application leaves our office, and make only verifiable public claims. We would rather grow steadily with the right partners than inflate numbers — and we believe that is exactly the kind of agent worth onboarding early.

We have active demand for Germany's 2026–27 intakes in the €10,000–20,000/year tuition range, well matched to IU's programmes. Could you share the next steps in your agent application process? Documents, verified records, or a call — whatever helps.

Warm regards,
[FOUNDER NAME]
Founder & CEO, RichenQuest Private Limited
Patna, India · richenquest.com · official@richenquest.com · [PHONE/WhatsApp]

---

## 2. GUS GATEWAY APPLICATION — ANSWER SHEET (v2)
...
**Existing institutional partnerships:** Newly incorporated; currently submitting our first direct partnership applications with German private institutions.
**References:** [1–2 real organizations with permission, or "available on request" — never invented]

**KYC documents to gather (one folder, PDFs):** ① Certificate of Incorporation ② Company PAN + GST ③ Founder/director government ID ④ Office address proof ⑤ Company profile (§3)

---

## 3. ONE-PAGE COMPANY PROFILE (v2 — for KYC and every future application)
...
**How we work.** We maintain verified records for every student placed under the company and make only verifiable public claims. Every application passes two-person document verification before submission. We are deploying a technology-first operations backbone — CRM-driven pipelines, automated follow-ups, and real-time application tracking — so that quality holds as volume grows.

**Why partner with us.** ① Ground presence in Bihar, eastern India, and Nepal — high-demand territories most metro-based agencies overlook. ② A focused core team that personally owns every application rather than pushing volume through untrained sub-agents. ③ A reputation strategy built on accuracy: we protect our partners' brands the way we protect our own.

**Growth.** Germany is our first destination focus, with our first direct institutional applications under way and expansion toward Ireland, the UK, and Canada to follow.

**Contact.** [FOUNDER NAME], Founder & CEO · official@richenquest.com · +91-[PHONE] · richenquest.com

---

## 4. INTERIM TRACKER + TASK LIST (unchanged from v1)

- [ ] A. Confirm official@richenquest.com sends/receives (else: registrar DNS screenshot → 15-min fix with me)
- [ ] B. Send me: founder name · phone · CIN · office address · decisions on open items ① and ②
- [ ] C. Documentation lead gathers the 5 KYC PDFs
- [ ] D. Send IU email (Tue–Thu, 1:30–3:30 pm IST)
- [ ] E. Create GUS Gateway account + submit answer sheet
- [ ] F. Report "IU sent [date]" / "GUS submitted [date]" → Milestone 1 done → Milestone 2 (Zoho activation) begins
